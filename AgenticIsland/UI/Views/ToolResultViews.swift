        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            HStack(spacing: 4) {
                ...
                Text(result.filename)
                    ...
                    .foregroundColor(TerminalColors.ivory.opacity(0.7))
            }
...
struct TodoWriteResultContent: View {
        ...
        VStack(alignment: .leading, spacing: 4) {
            ForEach(Array(result.newTodos.enumerated()), id: \.offset) { _, todo in
                HStack(spacing: 6) {
                    ...
                    Text(todo.content)
                        .font(.system(size: 11))
                        .foregroundColor(todo.status == "completed" ? TerminalColors.stoneGray : TerminalColors.warmSilver)
    ...
    private func todoColor(for status: String) -> Color {
        ...
        case "in_progress": return TerminalColors.coral
...
struct TaskResultContent: View {
    ...
    private var statusColor: Color {
        ...
        case "completed": return TerminalColors.green
        case "in_progress": return TerminalColors.coral
        case "failed", "error": return TerminalColors.red
        default: return TerminalColors.warmSilver
        }
    }
        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            HStack(spacing: 6) {
                Text("\(result.code)")
                    ...
                    .foregroundColor(result.code < 400 ? TerminalColors.green : TerminalColors.red)
...
struct FileCodeView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            .padding(.vertical, 6)
            .background(TerminalColors.surface.opacity(0.4))
...
private enum DiffLineType {
    ...
    var textColor: Color {
        switch self {
        case .added: return Color(red: 0.45, green: 0.72, blue: 0.42)
        case .removed: return Color(red: 0.82, green: 0.45, blue: 0.42)
        case .context: return TerminalColors.warmSilver
        }
    }

    var backgroundColor: Color {
        switch self {
        case .added: return Color(red: 0.2, green: 0.35, blue: 0.2).opacity(0.3)
        case .removed: return Color(red: 0.35, green: 0.2, blue: 0.18).opacity(0.3)

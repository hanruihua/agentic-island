...
struct ClaudeInstancesView: View {
    ...
    /// Sort by most recently active first (last activity timestamp)
    ...
    var body: some View {
        Button {
            ...
            Image(systemName: icon)
                .font(.system(size: 11, weight: .medium))
                .foregroundColor(isHovered ? TerminalColors.ivory : TerminalColors.stoneGray)
...
struct CompactTerminalButton: View {
    ...
    var body: some View {
        Button {
            ...
            .foregroundColor(isEnabled ? TerminalColors.ivory : TerminalColors.stoneGray)
            .padding(.horizontal, 6)
            .padding(.vertical, 2)
            .background(isEnabled ? TerminalColors.surface : TerminalColors.surface.opacity(0.3))
            .clipShape(Capsule())
        }
        .buttonStyle(.plain)
    }
...
struct TerminalButton: View {
    ...
    var body: some View {
        Button {
            ...
            .padding(.horizontal, 10)
            .padding(.vertical, 5)
            .background(isEnabled ? TerminalColors.prompt : TerminalColors.surface)
            .clipShape(Capsule())
        }
        .buttonStyle(.plain)
    }

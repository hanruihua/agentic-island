    ...
    var body: some View {
        VStack(spacing: 4) {
            ...
            MenuRow(
                ...
                if let url = URL(string: "https://github.com/hanruihua/agentic-island") {
...
struct UpdateRow: View {
    ...
    private var iconColor: Color {
        switch updateManager.state {
        case .idle:
            return isHovered ? TerminalColors.ivory : TerminalColors.warmSilver
        case .checking:
    ...
    private var labelColor: Color {
        ...
        case .checking, .downloading, .extracting, .installing:
            return TerminalColors.ivory.opacity(0.9)
        case .found, .readyToInstall:
            return TerminalColors.green
        case .error:
            return TerminalColors.red
            ...
            if isEnabled {
                ...
                Button(action: openAccessibilitySettings) {
                    Text("Enable")
                        ...
                        .foregroundColor(TerminalColors.nearBlack)
                        .padding(.horizontal, 10)
                        .padding(.vertical, 4)
                        .background(
                            RoundedRectangle(cornerRadius: 5)
                                .fill(TerminalColors.ivory)
                        )
                }
                .buttonStyle(.plain)
            }
    ...
    var body: some View {
        Button(action: action) {
            HStack(spacing: 10) {
                ...
                Circle()
                    .fill(isOn ? TerminalColors.green : TerminalColors.stoneGray)
                    .frame(width: 6, height: 6)
